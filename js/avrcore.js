...
function fetch(c, b) {
  ...
  if( pinD != 57005 )
  {
      if( pinDTimer )
          ...
          writeMemory( pinD, readMemory(portD) );
  }
  r[d] &= 255;
  r[h] &= 255;
  memory[ADCSRA] &= 191;
